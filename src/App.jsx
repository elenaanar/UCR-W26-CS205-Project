...
import { AuthProvider, useAuth, isNative } from './context/AuthContext'
...
function AppContent() {
  ...
  return (
    <HealthDataProvider>
      <div className="min-h-screen bg-gradient-to-br from-blue-50 to-indigo-100" style={{ paddingTop: 'env(safe-area-inset-top)' }}>
        <div className="container mx-auto px-4 py-8 max-w-7xl">
          ...
          <div className="mb-6 border-b border-gray-200 overflow-x-auto md:overflow-x-visible">
            <nav className="flex space-x-8 flex-nowrap md:flex-wrap">
              <button
